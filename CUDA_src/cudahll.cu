...
float invoke_kernel_1(HLL_matrix *hll_matrix, double *x, double *z, int num_threads)
{
    ...
    cuda_hll_kernel_v1<<<block_num, num_threads>>>(d_y, hll_matrix->hack_size, hll_matrix->hacks_num, d_data, d_offsets, d_col_index,
...
float invoke_kernel_2(HLL_matrix *hll_matrix, double *x, double *z, int num_threads)
{
    ...
    cuda_hll_kernel_v2<<<block_num, num_threads>>>(d_y, hll_matrix->hack_size, hll_matrix->hacks_num, d_data, d_offsets,
